...
const WeSee: iProject.Project = {
  title: '국시플래너 v2 기획/개발',
  startedAt: '2023.12',
  endedAt: '2024.05',
  company: '위씨',
  contribute: [
    '기존에 존재하던 서비스 "국시플래너"의 간호조무사 전용 서비스 기획 및 개발에 참여 ',
    '데스크리서치, 가설 설립, 타켓층 인터뷰, 사용자 테스트, 가설 검증을 통한 디자인, 개발 방향성 제시',
    '디자이너와 협업하여 일일 문제, 기출 문제, 마이페이지 등의 페이지를 Figma를 사용하여 공동 제작',
    '완성된 페이지를 React Native(Typescript)를 사용하여 개발 및 recoil을 활용한 상태관리 등 수행',
    'Firebase를 활용한 신규 서비스에 필요한 DB 구축',
  ],
}

const LandingPage: iProject.Project = {
